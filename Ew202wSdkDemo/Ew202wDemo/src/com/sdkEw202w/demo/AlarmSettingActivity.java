...
public class AlarmSettingActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// LogUtil.log(TAG+" onCreate alarmConfig:" +
		// alarmConfig+",h:"+sHour+",m:"+sMin+",eh:"+eHour+",em:"+eMin);
	...
	public void onClick(View v) {
		...
		if (v == vStartTime) {
			isStartTime = true;
			// timeDialog.setLabel(getString(R.string.cancel),
			// getString(R.string.set_start_time), getString(R.string.confirm));
			timeDialog.setDefaultValue(sHour, sMin);
			timeDialog.show();
		} else if (v == vEndTime) {
			isStartTime = false;
			// timeDialog.setLabel(getString(R.string.cancel),
			// getString(R.string.set_end_time), getString(R.string.confirm));
			...
			//
			// mHelper.setAlarm(alarmConfig.isEnable(), alarmConfig.getHour(),
			// alarmConfig.getMinute(), alarmConfig.getDuration(), 3000, new
